...
1. Open [Playground](<./Playground.md>) and place the cursor where the attachments should go.
...
- The individual embeds are joined together using the prefix, delimiter, and suffix from the plugin settings - see [02 Link formatting](<./02 Link formatting.md>) and [03 Settings](<./03 Settings.md>).
