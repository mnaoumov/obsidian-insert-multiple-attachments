...
// Insert Multiple Attachments runs a command that opens the OS file picker so you can choose several
// Files at once, so there is nothing for a code-button to drive - the demo notes walk through it
