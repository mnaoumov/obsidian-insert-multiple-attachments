...
// (rename drift). Insert Multiple Attachments' feature surface is an editor command
// With no public API interface, so only the PluginSettings config class is reflected;
...
registerDemoVaultCoverageSuite({
  ...
  nonTrivialGuard: {
    ...
    expectMember: 'attachmentLinksPrefix',
